...
L"Добро пожаловать в игру NedoPakman\n\n"
"Суть игры проста: нужно собирать частицы топлива и очки, убегая от врагов.\n"
"Для выбора карты нажмите на первую кнопку. Первая карта - учебная. Вторая - \n"
"интересная. Третья - недоработанная. Для выбора сложности нажмите на вторую\n"
"кнопку. Чем выше сложность, тем быстрее двигаются ваш персонаж и враги.\n"
"Для запуска игры нажмите на третью кнопку. Для выбора цветовой темы - на\n"
"четвёртую.\n"
"В игре: частицы топлива - зелёные. Очки - синие. Игра длится 2 минуты.\n"
"Каждая частица топлива добавляет 10 секунд движения. Максимум 120 секунд.\n"
"Максимум очков - 50. За каждые 10 очков вы получаете по одной звезде.\n"
"Рекорд запоминается отдельно для каждой карты и сложности. Он написан справа.\n"
"Приятной игры!\n\n"
"P.S. Пока в игре хорошо проработана только первая карта, так что рекомендую\n"
"играть её. Так же для старта лучше выбрать минимальную сложность, а затем\n"
